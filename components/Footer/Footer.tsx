...
export const Footer = () => {
    return (
        <footer className="relative bg-primary text-primary-foreground pt-24 pb-12 overflow-hidden">
            ...
            <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 text-[20vw] font-display font-bold text-white/[0.02] select-none pointer-events-none whitespace-nowrap">
                TAKE SOLUTIONS
            </div>
        </footer>
    );
